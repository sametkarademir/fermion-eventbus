...
namespace Fermion.EventBus.InMemory.Options;
...
public class EventBusInMemoryOptions
{
    ...
    public EventBusInMemoryOptions AddEventHandler<THandler>() where THandler : IntegrationEventHandler
    {
    ...
    /// <typeparam name="THandler">The type of the event handler.</typeparam>
    /// <returns>The options instance for chaining.</returns>
    public EventBusInMemoryOptions AddSubscription<TEvent, THandler>()
